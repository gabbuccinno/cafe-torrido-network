# 🌐 Café Torrido — Infraestrutura de Rede Corporativa

> Projeto completo de design, simulação e documentação de rede corporativa para o Café Torrido, Belo Horizonte — MG.
> Simulado integralmente no **Cisco Packet Tracer** antes da implementação física.
...
## ⚠️ Simulador vs Hardware Real

| Recurso | Packet Tracer | Hardware Real |
|---|---|---|
| NAT no ASA | Feito no roteador (limitação PT) | ASA nativo |
...
| Ping para câmeras IoT | Não suportado | Depende do firmware |
...
| Documento | Conteúdo |
|---|---|
| [Guia de Configuração](docs/guia-configuracao.pdf) | Comandos completos de todos os dispositivos em ordem otimizada |
| [Guia de Debug](docs/guia-debug.pdf) | 12 problemas documentados com causa raiz, solução e aprendizado |
| [Plano de Etiquetagem](docs/plano-etiquetagem.pdf) | ~160 etiquetas com código de cores por categoria |
...
**[Seu nome]**
[LinkedIn](https://linkedin.com/in/seu-perfil) · [Email](mailto:seu@email.com)
